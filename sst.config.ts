...
export default $config({
  ...
  async run() {
    ...
    api.route("GET /assessments", "src/assessments.list");
    api.route("GET /assessments/{strategy}", "src/assessments.get");
    api.route("POST /assessments/{strategy}/{narrative}", "src/assessments.assess");
